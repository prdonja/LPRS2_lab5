...
begin
      ...
      frame_color      <= (others => '0');
        ...
        if (reg_we = '1') then
          case (unit_addr) is
            ...
            when REG_ADDR_08 => enable      <= Bus2IP_Data(0);
            when others => null;
          end case;
        end if;
    end if;
  ...
  when ((pixel_row = v_sync_counter_tc(10 downto 0)) and enable) then is_equal <= '1' else
	is_equal = '0';
	
  baba_deda_irq <= is_equal and enable;
